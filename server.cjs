...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Water & Utility Services Management System";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Service Request";
process.env.TABLE_NAME = process.env.TABLE_NAME || "service_request_records";
'use strict';
